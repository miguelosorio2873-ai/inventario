...
Namespace inventario_visual
    ...
    Public Class PanelClientes
        ...
        Public Sub New()
            ...
            If SesionUsuario.TienePermisoAccion("Clientes", "CREAR") Then
            ...
            If SesionUsuario.TienePermisoAccion("Clientes", "EDITAR") Then
            ...
            If SesionUsuario.TienePermisoAccion("Clientes", "ELIMINAR") Then
        ...
        Private Sub CargarDatos()
            ...
            dt.Columns.Add("ID")
            dt.Columns.Add("CÃ©dula")
            dt.Columns.Add("Nombre")
            dt.Columns.Add("Correo")
            dt.Columns.Add("TelÃ©fono")
            For Each c In dao.ListarTodos()
                dt.Rows.Add(c.Id, c.Cedula, c.Nombre, c.Correo, c.Telefono)
            Next
            grid.DataSource = dt
        End Sub

        Private Sub Nuevo_Click(sender As Object, e As EventArgs)
            Using editor As New ClienteEditorForm()
        ...
        Private Sub Editar_Click(sender As Object, e As EventArgs)
            ...
            Dim cliente As Cliente = dao.ListarTodos().FirstOrDefault(Function(c) c.Id = id)
            If cliente Is Nothing Then Return
            Using editor As New ClienteEditorForm(cliente)
                If editor.ShowDialog() = DialogResult.OK Then CargarDatos()
            End Using
        End Sub
        ...
        Private Sub Eliminar_Click(sender As Object, e As EventArgs)
            If grid.SelectedRows.Count = 0 Then Return
            If MessageBox.Show("¿Eliminar el cliente seleccionado?", "Clientes", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) = DialogResult.Yes Then
